"""Shared fixtures for truth-graph tests.

Tests run against the repository's authored configuration and a fixed seed so
that count and determinism assertions are stable.
"""
...
# A fixed seed used across the suite; matches the milestone's example seed.
TEST_SEED = 20260717
