...
- **A versioned normalization contract** (`normalization_version` 1) governing
  what a round-trip forgives. It holds exactly one server-owned field, each
  entry carries a justification plus a paired test proving an adjacent
